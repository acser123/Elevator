...
class sharedData:
    ...
    travel_direction = NO_DIRECTION   # elevator direction of travel: "moving up", or "moving dn"
...
def controller():
    ...
    while True:
        ...
        if shared_data.wake_controller:
            ...
            # No direction (elevator stopped without any buttons pushed) travel logic
